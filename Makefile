...
CXXFLAGS = -std=c++11 -g -isystem ./boost_extension -isystem /Users/Adrien/Downloads/b_1_53_0 -isystem ../include -isystem $(MAIDSAFE_DIR)/include -isystem $(MAIDSAFE_DIR)/include/breakpad -I./libs -I. -DHAVE_NETINET_IN_H -fno-common -Wall -Wextra -Wformat=2 -Winit-self -Wp,-D_FORTIFY_SOURCE=2 -Wpointer-arith -Wlarger-than-65500 -Wmissing-declarations -Wmissing-format-attribute -Wmissing-noreturn -Wsign-compare -Wunreachable-code -Wwrite-strings -Wfloat-equal -Wno-unused-function -Wno-unused-parameter -fpermissive
