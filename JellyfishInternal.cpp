...
JellyInternalStatus::type JellyfishInternal::addPart( std::string const & id, std::string const & file, ClientProof const & client )
{
    return _jelly.localAdd(id, file, client);
}
